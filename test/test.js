  ...
  describe('GET /api/minions', function () {
    ...
    it('returns an array of all minions', function () {
      return request(app)
        ...
        .expect(200)
        .then((response) => {
          const length = fakeDb.getAllFromDatabase('minions').length
    ...
    it('deletes the correct minion by id', function () {
      ...
      return request(app)
        ...
        .then((afterDeleteMinionsArray) => {
          ...
          const shouldBeDeletedMinion = afterDeleteMinionsArray.find(el => el.id === '1')
  ...
  describe('GET /api/ideas', function () {
    ...
    it('returns an array of all ideas', function () {
      return request(app)
        ...
        .expect(200)
        .then((response) => {
          const length = fakeDb.getAllFromDatabase('ideas').length
          expect(response.body.length).to.be.equal(length)
    ...
    it('deletes the correct minion by id', function () {
      ...
      return request(app)
        ...
        .then((afterDeleteIdeasArray) => {
          ...
          const shouldBeDeletedIdea = afterDeleteIdeasArray.find(el => el.id === '1')
  ...
  describe('GET /api/meetings', function () {
    ...
    it('returns an array of all meetings', function () {
      return request(app)
        ...
        .expect(200)
        .then((response) => {
          const length = fakeDb.getAllFromDatabase('meetings').length
          expect(response.body.length).to.be.equal(length)
          response.body.forEach((minion) => {
    ...
    it('should persist the created meeting to the database', function () {
      ...
      return request(app)
        ...
        .then((newMeetingsArray) => {
          ...
          const createdMeetingFound = newMeetingsArray.some((meeting) => {
    ...
    it('updates the correct work item and persists to the database', function () {
      ...
      return request(app)
        ...
        .then((postUpdateWorkArray) => {
          const updatedWorkObject = postUpdateWorkArray.find((work) => work.id === initialWork.id)
    ...
    it('deletes the correct work by id', function () {
      ...
      return request(app)
        ...
        .then((afterDeleteWorkArray) => {
          ...
          const shouldBeDeletedWork = afterDeleteWorkArray.find((el) => el.id === '2')
